 ...
 */
export default class OsfAdapter<M extends OsfModel> extends JSONAPIAdapter.extend(DataAdapterMixin) {
    ...
    authorize(this: OsfAdapter<M>, xhr: XMLHttpRequest) {
        this.currentUser.authorizeXHR(xhr);
    }
